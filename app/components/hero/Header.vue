...
import { XMarkIcon, Bars4Icon } from "@heroicons/vue/24/outline";
...
<template>
  <div
    class="p-5 sm:px-16 sm:py-3 flex items-center w-full justify-between font-poppins"
  >
    <Logo />
    <div class="hidden lg:flex items-center space-x-20">
      <ul class="flex items-center space-x-12">
        <li><NuxtLink to="#">Applications</NuxtLink></li>
